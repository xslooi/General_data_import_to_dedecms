...
requirejs(['jquery', 'custom', 'jquery.ui', 'jquery.ztree.all.min'], function($, custom){
    ...
    functionLib.resetExportTablesList = function(){
        $.ajax({
            url: myDomain + 'api.php?act=resetExportTablesList',
            data: {},
            type: 'POST',
            dataType: 'json',
            async: false,
    ...
    functionLib.resetExportCateField = function(){
        $.ajax({
            url: myDomain + 'api.php?act=resetExportCateField',
            data: {},
            type: 'POST',
            dataType: 'json',
            async: false,
    ...
    functionLib.resetExportCateList = function() {
        ...
        $.ajax({
            url: myDomain + 'api.php?act=resetExportCateList',
            data: formData,
            type: 'POST',
            dataType: 'json',
            success: function (data) {
    ...
    functionLib.resetExportFieldList = function(){
        $.ajax({
            url: myDomain + 'api.php?act=resetExportFieldList',
            data: {},
            type: 'POST',
            dataType: 'json',
            async: false,
